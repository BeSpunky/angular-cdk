...
import { eachDayOfInterval, eachHourOfInterval, differenceInMinutes, differenceInSeconds, startOfSecond, startOfMinute, addMinutes, addSeconds, setHours, setMinutes } from 'date-fns';
import { AssignedTiketsByTiker } from '../../../../shared/services/routes-coordinator.service';

const DayParts       = ['Night', 'Morning', 'Noon', 'Evening'];
const HourPartsCount = 4;
...
{    
    ...
    public datesBetween = {
        ...
        hourParts: (start: Date, end: Date) => divideIntoParts(eachDayOfInterval({ start, end }), 60, HourPartsCount, setMinutes),
    ...
    public labels = {
        ...
        hourParts: (value: Date) => value.getMinutes(),
